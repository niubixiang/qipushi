...
},
{
	...
	children:[
	   ...
	   },
	   {
		   name:'users_manager',
		   path:'/users_manager',
		   component:()=>import('@/views/user_manager/users_manager/index.vue')
	   },
	   {
	   ...
	   {
		   name:'out_product_manager_list',
		   path:'/out_product_manager_list',
		   component:()=>import('@/views/product/out_product_manager_list/index.vue')
	   },
	   {
		   name:'message_list',
		   path:'/message_list',
